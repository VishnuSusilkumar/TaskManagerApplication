...
function RadialChart() {
  ...
  const tasksTotal = taskStatus.completed + taskStatus.pending;
    ...
    <Card className="flex flex-col border-2 border-white shadow-none bg-[#EDEDED]">
      ...
      <CardFooter className="flex-col gap-2 text-sm -mt-16">
        <div className="flex items-center gap-2 font-medium leading-none">
          Task completion improved by {taskStatus.completionRate}% this month{" "}
          <TrendingUp className="h-4 w-4" />
        </div>
        <div className="leading-none text-muted-foreground">
          Total tasks created in the last 30 days: {taskStatus.tasksCreatedLast30Days}
        </div>
        <div className="leading-none text-muted-foreground">
          Average completion time: {taskStatus.averageCompletionTime} hours
        </div>
        <div className="leading-none text-muted-foreground">
